...
import com.opensource.customdialog.CustomDialog;
import com.opensource.customdialog.CustomProgressDialog;
import com.opensource.customdialog.MenuDialog;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_menu_dialog:
                new MenuDialog(DialogActivity.this)
            ...
            case R.id.btn_msg_dialog:
                new CustomDialog(DialogActivity.this)
...
//					dialog.cancel();
            ...
            case R.id.btn_progress_dialog_spinner:
                CustomProgressDialog cpd = CustomProgressDialog.show(DialogActivity.this, null, getString(R.string.loading));
