...
package com.opensource.customdialog;
...
public class CustomDialog extends Dialog {
	 ...
	 * Note: The result is only valid if the items is {@link com.opensource.customdialog.CustomDialog#setSingleChoiceItems(CharSequence[], int, android.content.DialogInterface.OnClickListener)}(include all of method named setSingleChoiceItems())
	 ...
	 * Note: The result is only valid if the items is {@link com.opensource.customdialog.CustomDialog#setMultiChoiceItems(CharSequence[], int[], android.content.DialogInterface.OnMultiChoiceClickListener)}(include all of method named setMultiChoiceItems())
